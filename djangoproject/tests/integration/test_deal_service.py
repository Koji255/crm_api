...
from products.views import ProductItemModelViewSet
...
class TestDeal:
    def test_deal_crud(self, users_model, courses_model, deals_model, productitems_model, services):
        ...
        # Idempotency check
        deal = deal_service.create(account_id=account.pk)
        ...
        expected_value = deal_service.make_expected_value(deal.pk)
